...
> This list tries to cover what is ⚡️awesome⚡️ about [hackathons](https://en.wikipedia.org/wiki/Hackathon), hackdays and hacknights, and the community of organizers who run them! See also 🕶️[awesome-hackathons](https://github.com/mbiesiad/awesome-hackathons) ⭐ 54 | 🐛 0 | 📅 2024-05-24, 🕶️[awesome-hackathon-projects](https://github.com/Olanetsoft/awesome-hackathon-projects) ⭐ 1,783 | 🐛 5 | 📅 2025-05-20 and 🕶️[awesome-hackathon-starters](https://github.com/geekcamp-ph/awesome-hackathon-starters/issues/12) ⭐ 37 | 🐛 1 | 📅 2016-07-17. Are you interested in the *science* of hackathons? Join our new 📚 [Zotero library](https://www.zotero.org/groups/5538025/awesome_hackathons).
...
* [Dribdat](https://github.com/dribdat/dribdat) ⭐ 89 | 🐛 93 | 🌐 Python | 📅 2026-05-01 - **Hackathons for impact, based on open data and web standards.** `python` `js`
* [JunctionApp](https://github.com/hackjunction/JunctionApp) ⭐ 76 | 🐛 211 | 🌐 JavaScript | 📅 2025-07-01 - All-in-one hackathon platform for organisers, maintained by Junction.
...
* [Hack the Back](https://github.com/hackthevalley/hack-the-back) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-08-15 - An elegant backend, with ready-made GraphQL and REST endpoints.
...
* [Hackme](https://github.com/p1utoze/Hackme) ⭐ 1 | 🐛 6 | 🌐 Python | 📅 2026-08-17 (unmaintained?) - Minimalistic hackathon registration and participant status monitoring.
* [Planning Kit](https://hackathon-planning-kit.org/) - Get information about how to design a hackathon that fits your needs.

### Promoting

* [Hackalist](https://github.com/Hackalist/Hackalist.github.io#readme) ⭐ 490 | 🐛 0 | 🌐 HTML | 📅 2026-04-09 - A list of upcoming hackathons from around the world.
* [Scrapbook](https://github.com/hackclub/scrapbook) ⭐ 191 | 🐛 26 | 🌐 JavaScript | 📅 2026-08-15 by HackClub - A daily streak system & portfolio for your projects.
* [Hack Club](https://github.com/hackclub/hackathons#readme) ⭐ 166 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-08 - A curated list of hackathons organized for high schoolers.
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,334 | 🐛 1 | 📅 2026-07-27 - A list to inspire your coaches to motivate your teams to document their efforts ...with panache.
...
* [MLH Organizer Guide](https://github.com/MLH/mlh-hackathon-organizer-guide) ⭐ 350 | 🐛 13 | 🌐 CSS | 📅 2026-08-03 - Guide from Major League Hacking, popular at US schools.
