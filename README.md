...
> This list tries to cover what is ⚡️awesome⚡️ about [hackathons](https://en.wikipedia.org/wiki/Hackathon), hackdays and hacknights, and the community of organizers who run them! See also 🕶️[awesome-hackathons](https://github.com/mbiesiad/awesome-hackathons) ⭐ 54 | 🐛 0 | 📅 2024-05-24, 🕶️[awesome-hackathon-projects](https://github.com/Olanetsoft/awesome-hackathon-projects) ⭐ 1,816 | 🐛 6 | 📅 2025-05-20 and 🕶️[awesome-hackathon-starters](https://github.com/geekcamp-ph/awesome-hackathon-starters/issues/12) ⭐ 37 | 🐛 1 | 📅 2016-07-17. Are you interested in the *science* of hackathons? Join our new 📚 [Zotero library](https://www.zotero.org/groups/5538025/awesome_hackathons).
...
* [Dribdat](https://github.com/dribdat/dribdat) ⭐ 90 | 🐛 94 | 🌐 Python | 📅 2026-08-29 - **Hackathons for impact, based on open data and web standards.** `python` `js`
...
* [Scrapbook](https://github.com/hackclub/scrapbook) ⭐ 191 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-10 by HackClub - A daily streak system & portfolio for your projects.
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,430 | 🐛 1 | 📅 2026-09-10 - A list to inspire your coaches to motivate your teams to document their efforts ...with panache.
...
* [MLH Organizer Guide](https://github.com/MLH/mlh-hackathon-organizer-guide) ⭐ 349 | 🐛 13 | 🌐 CSS | 📅 2026-09-09 - Guide from Major League Hacking, popular at US schools.
