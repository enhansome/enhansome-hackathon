...
> This list tries to cover what is ⚡️awesome⚡️ about [hackathons](https://en.wikipedia.org/wiki/Hackathon), hackdays and hacknights, and the community of organizers who run them! See also 🕶️[awesome-hackathons](https://github.com/mbiesiad/awesome-hackathons) ⭐ 54 | 🐛 0 | 📅 2024-05-24, 🕶️[awesome-hackathon-projects](https://github.com/Olanetsoft/awesome-hackathon-projects) ⭐ 1,832 | 🐛 6 | 📅 2025-05-20 and 🕶️[awesome-hackathon-starters](https://github.com/geekcamp-ph/awesome-hackathon-starters/issues/12) ⭐ 37 | 🐛 1 | 📅 2016-07-17. Are you interested in the *science* of hackathons? Join our new 📚 [Zotero library](https://www.zotero.org/groups/5538025/awesome_hackathons).
...
* [Civic Tech Exchange](https://github.com/DemocracyLab/CivicTechExchange) ⭐ 105 | 🐛 162 | 🌐 JavaScript | 📅 2026-09-11 - Online platform for Democracy Lab projects.
* [Dribdat](https://github.com/dribdat/dribdat) ⭐ 91 | 🐛 94 | 🌐 Python | 📅 2026-08-29 - **Hackathons for impact, based on open data and web standards.** `python` `js`
* [JunctionApp](https://github.com/hackjunction/JunctionApp) ⭐ 78 | 🐛 211 | 🌐 JavaScript | 📅 2025-07-01 - All-in-one hackathon platform for organisers, maintained by Junction.
* [Hibiscus](https://github.com/HackSC/hibiscus) ⭐ 54 | 🐛 5 | 🌐 TypeScript | 📅 2025-05-07 - An all-in-one, plug-and-play hackathon platform, created for HackSC.
...
* [DeltaHacks Portal](https://github.com/deltahacks/portal) ⭐ 20 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-08 - The attendee & admin portal for DeltaHacks 10, the hackathon for change.
...
* [Hack the Back](https://github.com/hackthevalley/hack-the-back) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-09-13 - An elegant backend, with ready-made GraphQL and REST endpoints.
...
* [Quill](https://github.com/techx/quill) ⭐ 453 | 🐛 60 | 🌐 JavaScript | 📅 2022-12-22 - A registration system designed especially for large hackathons, maintained by HackMIT.
...
* [LaraHack](https://github.com/ScientificClubofESI/LaraHack) ⭐ 122 | 🐛 3 | 🌐 PHP | 📅 2023-02-02 - Administration system designed for hackathons and similar competitions.
...
* [HackPortal](https://github.com/acmutd/hackportal) ⭐ 51 | 🐛 28 | 🌐 TypeScript | 📅 2025-01-27 - A platform from HackUTD for user-friendly event management.
...
* [Hacksuite](https://github.com/DevtranetHQ/Hacksuite) ⭐ 3 | 🐛 14 | 🌐 JavaScript | 📅 2023-04-07 - A fullstack suite of apps from [Devtranet](https://devtranet.tech/) for hosting virtual hackathons.
...
* [Hackme](https://github.com/p1utoze/Hackme) ⭐ 1 | 🐛 6 | 🌐 Python | 📅 2026-09-14 (unmaintained?) - Minimalistic hackathon registration and participant status monitoring.
...
* [Scrapbook](https://github.com/hackclub/scrapbook) ⭐ 191 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-16 by HackClub - A daily streak system & portfolio for your projects.
...
* [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,445 | 🐛 1 | 📅 2026-09-10 - A list to inspire your coaches to motivate your teams to document their efforts ...with panache.
...
* [Gavel](https://github.com/anishathalye/gavel) ⭐ 488 | 🐛 11 | 🌐 Python | 📅 2026-02-20 - A project expo judging system by HackMIT that uses fancy math to get good results.
...
* [Hackday Manifesto](https://github.com/hackdaymanifesto/site) ⭐ 427 | 🐛 11 | 🌐 HTML | 📅 2025-01-31 - How to make your event a success, and avoid common pitfalls.
* [MLH Organizer Guide](https://github.com/MLH/mlh-hackathon-organizer-guide) ⭐ 348 | 🐛 14 | 🌐 CSS | 📅 2026-09-14 - Guide from Major League Hacking, popular at US schools.
...
* [Dribdat wiki](https://github.com/dribdat/docs/wiki) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2026-06-20 - Community sourced guidelines from an open source project.
...
This repo is made with [generator-awesome-list](https://github.com/dar5hak/generator-awesome-list) ⚠️ Archived by Darshak Parikh and :heart: motivated by [awesome-hackathons](https://github.com/cconsidine/awesome-hackathons) by Camille Considine.
